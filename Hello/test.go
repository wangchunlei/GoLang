...
can include line breaks.` // Same string type.
    ...
    s1 := []int{1, 2, 3}     // Result is a slice of length 3.
    s1 = append(s1, 4, 5, 6)  // Added 3 elements. Slice now has length of 6.
    fmt.Println(s1) // Updated slice is now [1 2 3 4 5 6]
    // To append another slice, instead of list of atomic elements we can
    // pass a reference to a slice or a slice literal like this, with a
    // trailing elipsis, meaning take a slice and unpack its elements,
    // appending them to slice s.
    s1 = append(s1, []int{7, 8, 9}...) // Second argument is a slice literal.
    fmt.Println(s1)  // Updated slice is now [1 2 3 4 5 6 7 8 9]
